...
As a leverage of tidyverse, tidy formulas can be used to compute the statistical descriptions.
...
The named list can contain named functions such as `t.test` prefixed with *~*. Please note the necessity to use **~** before any function as a leverage of tidyverse formulas.
